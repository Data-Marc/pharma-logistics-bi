...
#### 📦 **TRANSPORT KPIs** (12 KPIs)
Order fulfillment, carrier performance, logistics operations — OTIF %, Lead Time, Cost per KM, CO2 Emissions

#### 🏭 **WAREHOUSE KPIs** (18 KPIs)
Inventory management, stock levels, warehouse operations — DOH, Inventory Turns, Expiry Risk, Stock Health

#### ⚙️ **PERFORMANCE KPIs** (16 KPIs)
Operational efficiency, quality compliance, forecast accuracy — Cold Chain Compliance, MAPE, Return Rate, Temperature Excursions

#### 💰 **FINANCIAL KPIs** (16 KPIs)
Profitability, cost-to-serve, inventory value — Revenue, COGS, Gross Margin, Logistics Cost, Net Contribution
